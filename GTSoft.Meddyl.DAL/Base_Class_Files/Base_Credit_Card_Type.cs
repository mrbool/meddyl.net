...
namespace GTSoft.Meddyl.DAL
{
	public class Base_Credit_Card_Type
	{
		...
		public bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[sp_Credit_Card_Type_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@p_image", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, image));
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Credit_Card_Type_Insert' reported the ErrorCode: " + errorCode);
				}
		...
		public bool UpdatePK_type_id()
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Credit_Card_Type_UpdatePK_type_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Credit_Card_Type_UpdatePK_type_id' reported the ErrorCode: " + errorCode);
				}
		...
		public bool DeletePK_type_id()
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Credit_Card_Type_DeletePK_type_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Credit_Card_Type_DeletePK_type_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Credit_Card_Type_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Credit_Card_Type_SelectAll' reported the ErrorCode: " + errorCode);
				}
		...
		public DataTable SelectPK_type_id()
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Credit_Card_Type_SelectPK_type_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Credit_Card_Type");
			SqlDataAdapter adapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Credit_Card_Type_SelectPK_type_id' reported the ErrorCode: " + errorCode);
				}
