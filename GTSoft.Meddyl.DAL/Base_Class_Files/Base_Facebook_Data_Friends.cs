...
{
	public class Base_Facebook_Data_Friends
	{
		#region variables
		...
		public Base_Facebook_Data_Friends()
		{
		...
		public bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[sp_Facebook_Data_Friends_Insert]";
			...
			try
			{
				...
				scmCmdToExecute.Parameters.Add(new SqlParameter("@p_fb_friend_id", SqlDbType.BigInt, 8, ParameterDirection.Input, false, 19, 0, "", DataRowVersion.Proposed, fb_friend_id));
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Facebook_Data_Friends_Insert' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Facebook_Data_Friends_UpdatePK_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Facebook_Data_Friends_UpdatePK_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Facebook_Data_Friends_DeletePK_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Facebook_Data_Friends_DeletePK_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Facebook_Data_Friends_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Facebook_Data_Friends");
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Facebook_Data_Friends_SelectAll' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Facebook_Data_Friends_SelectPK_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Facebook_Data_Friends");
			SqlDataAdapter adapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Facebook_Data_Friends_SelectPK_id' reported the ErrorCode: " + errorCode);
				}
		...
		public SqlInt64 fb_friend_id { get; set; }
