...
namespace GTSoft.Meddyl.DAL
{
	public class Base_Deal_Payment
	{
		...
		public bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_Insert]";
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_Insert' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_UpdatePK_payment_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_UpdatePK_payment_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_DeletePK_payment_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_DeletePK_payment_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_DeleteFK_Credit_Card_credit_card_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_DeleteFK_Credit_Card_credit_card_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_DeleteFK_Deal_deal_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_DeleteFK_Deal_deal_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_DeleteFK_Promotion_Activity_promotion_activity_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_DeleteFK_Promotion_Activity_promotion_activity_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Deal_Payment");
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_SelectAll' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_SelectPK_payment_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Deal_Payment");
			SqlDataAdapter adapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_SelectPK_payment_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_SelectFK_Credit_Card_credit_card_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Deal_Payment");
			SqlDataAdapter adapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_SelectFK_Credit_Card_credit_card_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_SelectFK_Deal_deal_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Deal_Payment");
			SqlDataAdapter adapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_SelectFK_Deal_deal_id' reported the ErrorCode: " + errorCode);
				}
		...
		{
			SqlCommand scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[sp_Deal_Payment_SelectFK_Promotion_Activity_promotion_activity_id]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			scmCmdToExecute.CommandTimeout = connection_timeout;
			DataTable toReturn = new DataTable("Deal_Payment");
			SqlDataAdapter adapter = new SqlDataAdapter(scmCmdToExecute);
			...
			try
			{
				...
				{
					/* throw error */
					throw new Exception("Stored Procedure 'sp_Deal_Payment_SelectFK_Promotion_Activity_promotion_activity_id' reported the ErrorCode: " + errorCode);
				}
